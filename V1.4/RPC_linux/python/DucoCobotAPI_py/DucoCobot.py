...
class DucoCobot:
    ...
    def read_raw_data_485_h(self, _return, head, len):
        return self.client.read_raw_data_485_h(_return, head, len)

    def read_raw_data_485_ht(self, _return, head, tail):
        return self.client.read_raw_data_485_ht(_return, head, tail)
    ...
    def enable_speed_optimization(self, block):
        return self.client.enable_speed_optimization(block)

    def disable_speed_optimization(self, block):
        return self.client.disable_speed_optimization(block)
